...
\ref{sec:pipeline}, the analyser puts tags after the lemma
corresponding to the inflected part, and then finally the uninflected
part of the multiword lemma. The bilingual dictionary has the
uninflected part before the tags, since it has to allow tag prefixes
instead of requiring full tag sequences. Section \ref{sec:lemqmove}
details how we move the uninflected part after the tags in
