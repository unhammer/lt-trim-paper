...
there are still 27 dictionaries which miss out on your work. If we
were to create all possible translation pairs of the 34 languages
appearing in currently released language pairs, we would need 1156
...
of Apertium resources for other systems: If I want to create a speller
for some language supported by Apertium, I either have to manually
