...
input bilingual FST and the output trimmed analyser FST. It is
typically called from makefiles in Apertium.

% TODO: runtime is about the same as compile-time
